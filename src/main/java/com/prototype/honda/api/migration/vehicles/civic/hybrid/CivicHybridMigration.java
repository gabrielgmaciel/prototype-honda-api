package com.prototype.honda.api.migration.vehicles.civic.hybrid;
...
@ChangeUnit(id = "CivicHybridMigration", order = "002", author = "prototype-honda-api")
public class CivicHybridMigration {

    private static final String PATH_MIGRATION = "migration/vehicles/civic-hybrido/";

    @Execution
    public void migrate(CarsRepository repository, JsonLoader jsonLoader) {
        Optional<CarsModel> data = jsonLoader
                .loadJsonAsObject("classpath:" + PATH_MIGRATION + "civic-hybrido.json", CarsModel.class).stream()
                .findFirst();
        ...
        repository.saveAll(data.stream()
                .peek(car -> {
                    ...
                    car.setImages(Arrays.asList(
                            ...
                            Utils.saveFile(getFile("2.jpeg")),
                            Utils.saveFile(getFile("3.jpeg")),
