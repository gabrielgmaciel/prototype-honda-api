package com.prototype.honda.api.migration.vehicles.city;
...
@ChangeUnit(id = "CityHatchbackMigration", order = "002", author = "prototype-honda-api")
public class CityHatchbackMigration {

    private static final String PATH_MIGRATION = "migration/vehicles/city-hatch/";

    @Execution
    public void migrate(CarsRepository repository, JsonLoader jsonLoader) {
        Optional<CarsModel> data = jsonLoader
                .loadJsonAsObject("classpath:" + PATH_MIGRATION + "city-hatch.json", CarsModel.class).stream()
                .findFirst();
